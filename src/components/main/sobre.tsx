    ...
    return (
        <div id='sobre'>
            <div className="text-white pt-3 text-center xl:text-left lg:text-left">
                ...
                <p className="pl-1 pt-4 max-w-md m-auto xl:m-0 lg:m-0">Sou um desenvolvedor Frontend Web e as vezes me aventuro em Unreal Engine para criação de GameMods!</p>
            </div>
