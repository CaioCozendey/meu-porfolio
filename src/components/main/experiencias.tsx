...
const xps = [
    ...
    { id: 2, funcao: "Desenvolvedor Python Junior I", nome: "Tree Inova", tempo: "10/23 - Atual", imagem: "/tree-inova.png", tech1: "Python , Selenium", tech2: "Roberty Studio", tech3: "RPA", urlEmpresa: "https://www.treeinova.com.br/" },
]
